...
})({"6J9zn":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "2f4b9a7f55facd88";
"use strict";
...
},{}],"7w0md":[function(require,module,exports,__globalThis) {
 ...
 */ class ClarityEventTracker {
   ...
   */ trackEvent(eventName, properties = {}) {
        ...
        if (typeof window.clarity !== 'function' || window.clarityBlocked === true) // Clarity tracking skipped - unavailable
        return;
...
if (typeof window !== 'undefined') window.clarityTracking = {
    trackEvent: (eventName, properties)=>clarityTracker.trackEvent(eventName, properties),
    trackConversionMilestone: (milestone, details)=>clarityTracker.trackConversionMilestone(milestone, details),
    trackIntentSignal: (signal, strength)=>clarityTracker.trackIntentSignal(signal, strength),
    trackContentEngagement: (type, id, action, details)=>clarityTracker.trackContentEngagement(type, id, action, details),
    trackMicroConversion: (type, value)=>clarityTracker.trackMicroConversion(type, value),
    getUserJourneySummary: ()=>clarityTracker.getUserJourneySummary(),
    exportJourneyData: ()=>clarityTracker.exportJourneyData()
};
exports.default = clarityTracker;
...
},{}]},["6J9zn"], null, "parcelRequire9b4d", {})

//# sourceMappingURL=clarity-config.55facd88.js.map
