...
})({"9Qd78":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "5056090f42ffe72c";
"use strict";
...
},{}],"6o7Kx":[function(require,module,exports,__globalThis) {
...
const loadSiteHeaderModule = ()=>require("6e019d702f67d0ed");
const loadSiteFooterModule = ()=>require("90d35f4a93332671");
// Lazy load non-critical components and systems
const loadAnalyticsModule = ()=>require("d4ce8ed617a6d38f");
const loadClarityModule = ()=>require("c9ed75e1568ffd02");
const loadImageLoaderModule = ()=>require("bd73037029cebbfc");
const loadImageLightboxModule = ()=>require("d9d1f6bee5c2695e");
const loadSidebarNavigationModule = ()=>require("dbae9f6920664e3d");
const loadPasswordProtectionModule = ()=>require("b17891e6ef55a2da");
...
window.loadImageLightbox = async ()=>{
    try {
        ...
        if (!customElements.get('image-lightbox')) customElements.define('image-lightbox', ImageLightbox);
...
if (!('customElements' in window && 'attachShadow' in Element.prototype)) console.warn('Web Components not supported - some features may not work');
...
document.addEventListener('DOMContentLoaded', async ()=>{
    ...
    try {
        const [{ default: SiteHeader }, { default: SiteFooter }] = await Promise.all([
            loadSiteHeaderModule(),
            loadSiteFooterModule()
        ]);
    ...
    window.loadAnalytics().then(()=>{
        ...
        document.querySelectorAll("a[href^='http']").forEach((link)=>{
            if (link instanceof HTMLAnchorElement && link.hostname !== window.location.hostname) link.addEventListener('click', ()=>{
                window.portfolioAnalytics?.trackExternalLink(link.href, link.textContent?.trim() || '');
            });
        });
    });
    ...
    if (document.querySelector('.sidebar-nav')) try {
        const SidebarNavigation = await window.loadSidebarNavigation();
        if (SidebarNavigation) new SidebarNavigation();
    } catch (error) {
        console.warn('Failed to load SidebarNavigation:', error);
    }
    // Initialize ImageLightbox on project pages
    if (document.querySelector('body.project')) try {
...
if ('serviceWorker' in navigator) window.addEventListener('load', ()=>{
    navigator.serviceWorker.register(require("add959743d678f30")).then((registration)=>{
...
},{"../css/main.css":"7E1TK","6e019d702f67d0ed":"33crj","90d35f4a93332671":"jZt7E","d4ce8ed617a6d38f":"1eewm","c9ed75e1568ffd02":"egIvL","bd73037029cebbfc":"dFSqF","d9d1f6bee5c2695e":"7AL6S","dbae9f6920664e3d":"1Xsdb","b17891e6ef55a2da":"K12Ta","add959743d678f30":"iRt5e"}],"7E1TK":[function() {},{}],"33crj":[function(require,module,exports,__globalThis) {
module.exports = import("./SiteHeader.c7cde784.js").then(()=>module.bundle.root('ivc2T'));

},{"ivc2T":"ivc2T"}],"jZt7E":[function(require,module,exports,__globalThis) {
module.exports = import("./SiteFooter.9735e3ae.js").then(()=>module.bundle.root('3oZLV'));

},{"3oZLV":"3oZLV"}],"1eewm":[function(require,module,exports,__globalThis) {
module.exports = import("./simple-analytics.b1454544.js").then(()=>module.bundle.root('9ALXu'));

},{"9ALXu":"9ALXu"}],"egIvL":[function(require,module,exports,__globalThis) {
module.exports = import("./clarity-config.55facd88.js").then(()=>module.bundle.root('7w0md'));

},{"7w0md":"7w0md"}],"dFSqF":[function(require,module,exports,__globalThis) {
module.exports = import("./enhanced-image-loader.b0ea52fb.js").then(()=>module.bundle.root('eCUv4'));

},{"eCUv4":"eCUv4"}],"7AL6S":[function(require,module,exports,__globalThis) {
module.exports = import("./ImageLightbox.850f3e7e.js").then(()=>module.bundle.root('7PxOR'));

},{"7PxOR":"7PxOR"}],"1Xsdb":[function(require,module,exports,__globalThis) {
module.exports = import("./SidebarNavigation.f9598751.js").then(()=>module.bundle.root('cXW2g'));

},{"cXW2g":"cXW2g"}],"K12Ta":[function(require,module,exports,__globalThis) {
module.exports = import("./password-protection.3a822f86.js").then(()=>module.bundle.root('2AEDI'));

},{"2AEDI":"2AEDI"}],"iRt5e":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("js/service-worker.js");

},{}]},["9Qd78","6o7Kx"], "6o7Kx", "parcelRequire9b4d", {}, "./", "/")

//# sourceMappingURL=jaswetz.github.io.42ffe72c.js.map
