/**
 * Simplified Analytics - Ultra-lightweight analytics solution
 * Target size: <5KB total, essential tracking only
 * Covers: page views, project clicks, contact events
 */
...
class SimpleAnalytics {
   ...
   */
  trackImageLightbox(action, imageName = "") {
    this._sendToGA4("image_lightbox", {
      action: action,
