...
})({"04va0":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b2855bb28d8e1d65";
"use strict";
...
},{}],"3H1Dj":[function(require,module,exports,__globalThis) {
/**
 ...
 */ parcelHelpers.export(exports, "protectCaseStudy", ()=>protectCaseStudy);
/**
 ...
 */ parcelHelpers.export(exports, "getCaseStudyIdFromUrl", ()=>getCaseStudyIdFromUrl);
/**
 * Auto-protect case study based on current URL
 * Automatically detects and protects case study if it's in the config
 */ parcelHelpers.export(exports, "autoProtectCaseStudy", ()=>autoProtectCaseStudy);
var _passwordProtectionJs = require("./auth/password-protection.js");
function protectCaseStudy(caseStudyId) {
    return (0, _passwordProtectionJs.initPasswordProtection)(caseStudyId);
}
function getCaseStudyIdFromUrl() {
    const path = window.location.pathname;
    const filename = path.split("/").pop();
    if (filename && filename.endsWith(".html")) return filename.replace(".html", "");
    return null;
}
function autoProtectCaseStudy() {
    const caseStudyId = getCaseStudyIdFromUrl();
    if (caseStudyId) return protectCaseStudy(caseStudyId);
    console.warn("Could not determine case study ID from URL");
    return null;
}

},{"./auth/password-protection.js":"a0Qdy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a0Qdy":[function(require,module,exports,__globalThis) {
/**
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PasswordProtection", ()=>PasswordProtection);
/**
 ...
 */ parcelHelpers.export(exports, "initPasswordProtection", ()=>initPasswordProtection);
var _passwordConfigJs = require("./password-config.js");
class PasswordProtection {
    constructor(caseStudyId){
        this.caseStudyId = caseStudyId;
        this.config = (0, _passwordConfigJs.getCaseStudyConfig)(caseStudyId);
        this.storageKey = `${(0, _passwordConfigJs.PASSWORD_CONFIG).global.storagePrefix}${caseStudyId}`;
   ...
   */ isAuthenticated() {
        try {
            ...
            const now = Date.now();
            const sessionDuration = (0, _passwordConfigJs.PASSWORD_CONFIG).global.sessionDuration;
   ...
   */ handleCancel() {
        ...
        if (window.history.length > 1 && document.referrer) window.history.back();
            ...
            const redirectUrl = this.config.redirectOnCancel || (0, _passwordConfigJs.PASSWORD_CONFIG).global.defaultRedirect;
   ...
   */ static logoutAll() {
        ...
        const prefix = (0, _passwordConfigJs.PASSWORD_CONFIG).global.storagePrefix;
        keys.forEach((key)=>{
            if (key.startsWith(prefix)) localStorage.removeItem(key);
        });
    }
}
function initPasswordProtection(caseStudyId) {
...
},{"./password-config.js":"fd0hl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fd0hl":[function(require,module,exports,__globalThis) {
/**
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PASSWORD_CONFIG", ()=>PASSWORD_CONFIG);
/**
 * Get configuration for a specific case study
 * @param {string} caseStudyId - The case study identifier
 * @returns {object|null} Configuration object or null if not protected
 */ parcelHelpers.export(exports, "getCaseStudyConfig", ()=>getCaseStudyConfig);
/**
 * Check if a case study is protected
 * @param {string} caseStudyId - The case study identifier
 * @returns {boolean} True if protected, false otherwise
 */ parcelHelpers.export(exports, "isCaseStudyProtected", ()=>isCaseStudyProtected);
/**
 * Get all protected case study IDs
 * @returns {string[]} Array of protected case study IDs
 */ parcelHelpers.export(exports, "getProtectedCaseStudyIds", ()=>getProtectedCaseStudyIds);
...
},{}],"aw6Cz":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "SimpleAnalytics", ()=>SimpleAnalytics);
...
if (typeof window !== 'undefined') {
    ...
    const globalAPI = {
        ...
        trackCaseStudyCompletion: (...args)=>analytics.trackCaseStudyCompletion(...args),
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["04va0"], null, "parcelRequire9b4d", {})

//# sourceMappingURL=project-adsk-notification.8d8e1d65.js.map
